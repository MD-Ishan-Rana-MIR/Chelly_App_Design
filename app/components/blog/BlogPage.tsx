            ...
            <section className="mx-auto font-sans py-12 bg-white">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {blogData.map((post) => (
                        <div
                            key={post.id}
                            onClick={() => { router.push(`/blog-details/${post?.id}`) }}
                        ...
                        >
                            <div>
                                {/* Title */}
                                <h3 className="text-white hover:underline text-xl md:text-2xl font-serif font-medium leading-snug mb-3 tracking-wide group-hover:text-neutral-100 transition-colors duration-300">
                                    {post.title}
                                </h3>
