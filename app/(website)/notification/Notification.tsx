...
import { useDeleteNotificationMutation, useGetNotificationsQuery, useMarkAllNotificationsAsReadMutation, useMarkSingleNotificationAsReadMutation } from '@/app/redux/notificationApi';
import { NotificationItem } from '@/app/lib/type';
import { useUserProfileQuery } from '@/app/redux/authApi';
...
export default function Notification() {
    ...
    const deleteModalOpen = (e: React.MouseEvent, id: null | number) => {
        e.stopPropagation();
        setId(id);
    ...
    const handleNotificationClick = async (notification: NotificationItem) => {
        ...
        try {
            await markSingleNotificationAsRead(String(notification.id)).unwrap();
        ...
        <div className="min-h-screen bg-gray-50 p-4 md:p-8 rounded-2xl">
            <div className="mx-auto max-w-4xl">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-3">
                                            <button
                                                onClick={(e) => deleteModalOpen(e, notification.id)}
                ...
                <ConfirmModal
                    ...
                    confirmText={deletLoading ? "Deleteing..." : "Yes, Delete"}
                    cancelText="Cancel"
