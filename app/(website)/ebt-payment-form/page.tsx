                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#333333] text-sm font-medium">First Name</label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#333333] text-sm font-medium">Last Name</label>
                            <input
                                type="text"
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[#333333] text-sm font-medium">Address Line 1</label>
                        <input
                            type="text"
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[#333333] text-sm font-medium">Address Line 2</label>
                        <input
                            type="text"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pb-4">
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#333333] text-sm font-medium">Zip Code</label>
                            <input
                                type="text"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 border-t border-gray-200">
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#333333] text-sm font-medium">EBT (SNAP) Card Number</label>
                            <input
                                type="text"
                                maxLength={19}
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#333333] text-sm font-medium">EBT (SNAP) PIN</label>
                            <input
                                type="password"
                                maxLength={4}
                                value={formData.pin}
                            ...
                            <div className="space-y-2.5">
                                <label className="flex items-center gap-3 cursor-pointer text-[#333333] text-sm subpixel-antialiased">
                                    <input
                                        ...
                                        onChange={(e) => setFormData({ ...formData, meal70Select: e.target.value })}
                            ...
                            <div className="space-y-2.5">
                                <label className="flex items-center gap-3 cursor-pointer text-[#333333] text-sm subpixel-antialiased">
                                    <input
                                        ...
                                        onChange={(e) => setFormData({ ...formData, meal130Select: e.target.value })}
                                        className="w-4 h-4 text-[#1e3a61] focus:ring-[#1e3a61] border-gray-300"
                                    />
                                    Yes
                                </label>
                        ...
                        <div className="space-y-2.5">
                            <label className="flex items-center gap-3 cursor-pointer text-[#333333] text-sm subpixel-antialiased">
                                <input
                                    ...
                                    onChange={(e) => setFormData({ ...formData, permissionSelect: e.target.value })}
                                    className="w-4 h-4 text-[#1e3a61] focus:ring-[#1e3a61] border-gray-300"
                                />
                                Yes
                            </label>
